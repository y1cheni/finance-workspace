  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100">
      <div className="bg-white rounded-2xl shadow-xl p-10 w-full max-w-md text-center">
        ...
        <h1 className="text-2xl font-bold text-gray-900 mb-2">Financial Modeling Tool</h1>
        <p className="text-gray-500 mb-8 text-sm">複利、退休規劃、財務報表視覺化</p>
        ...
        <p className="text-xs text-gray-400 mt-6">開源專案 · 免費使用 · 資料不外洩</p>
      </div>
    </div>
  )
}
